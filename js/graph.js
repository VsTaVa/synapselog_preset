...
const SATELLITE_ICON_PATH = "M 210.50 658.43 C208.85,658.20 203.45,657.51 198.50,656.89 C187.56,655.53 173.95,651.73 168.39,648.48 C161.48,644.45 158.66,640.33 156.08,630.58 C154.05,622.92 153.91,621.25 154.96,617.73 C158.40,606.25 172.83,591.50 195.50,576.29 C208.83,567.35 218.15,561.81 218.79,562.45 C219.44,563.10 228.01,585.35 227.70,585.59 C227.59,585.67 223.29,588.33 218.14,591.50 C205.88,599.04 193.91,608.10 186.70,615.31 C177.62,624.38 179.04,627.45 193.75,630.51 C235.49,639.20 318.06,631.71 425.00,609.53 C468.09,600.59 575.37,571.28 620.48,556.13 C623.76,555.02 626.50,554.20 626.56,554.31 C626.61,554.41 628.35,557.88 630.41,562.00 C632.47,566.12 635.29,570.99 636.68,572.82 C638.07,574.64 639.04,576.27 638.85,576.43 C638.33,576.87 612.28,585.34 599.00,589.39 C580.97,594.89 503.77,616.31 480.00,622.41 C418.40,638.21 351.15,650.27 289.50,656.56 C275.51,657.99 217.34,659.36 210.50,658.43 ZM 700.62 594.89 C684.45,592.75 670.28,585.50 657.89,573.05 C650.78,565.90 648.47,562.74 644.64,554.94 C642.09,549.75 639.24,542.58 638.30,539.00 C635.97,530.10 636.01,511.74 638.39,503.06 C645.33,477.73 663.07,458.70 687.50,450.39 C698.89,446.52 716.06,445.87 728.08,448.87 C742.16,452.37 752.07,458.02 762.50,468.48 C772.72,478.73 776.89,485.20 781.34,497.74 C784.24,505.92 784.45,507.42 784.47,520.50 C784.50,536.43 782.71,544.24 776.31,556.00 C761.36,583.44 731.19,598.95 700.62,594.89 ZM 799.05 503.35 C798.36,500.24 796.94,495.22 795.90,492.19 C794.85,489.17 794.00,486.17 794.00,485.55 C794.00,484.92 799.06,481.52 805.25,478.00 C819.67,469.78 837.77,457.64 845.74,450.83 C859.84,438.78 860.85,434.59 850.33,431.71 C839.48,428.73 831.56,427.73 814.06,427.11 L 796.61 426.50 L 794.85 416.50 C793.88,411.00 792.82,405.43 792.49,404.12 L 791.90 401.74 L 813.70 402.26 C844.93,403.02 862.88,406.81 873.68,414.92 C878.04,418.20 878.77,419.34 881.30,427.02 C885.97,441.12 884.07,447.52 871.17,461.21 C863.12,469.75 852.40,478.22 837.00,488.23 C826.28,495.20 802.31,509.00 800.93,509.00 C800.59,509.00 799.75,506.46 799.05,503.35 Z";
const SATELLITE_ICON = (typeof Path2D !== 'undefined') ? new Path2D(SATELLITE_ICON_PATH) : null;
// 아이콘 바운딩박스 중심·크기 (viewBox 1024) — 위치 보정용
const SAT_BBOX = { cx: 519, cy: 530, w: 730, h: 257 };
...
function draw() {
  ...
  nodes.forEach(n => {
    ...
    if(n._satelliteRoot && SATELLITE_ICON) {
      ...
      ctx.fillStyle = isDim ? 'rgba(254,123,1,0.18)' : 'rgba(254,123,1,0.95)';
