...
const SATELLITE_ICON_PATH = "M 221.39 645.84 C189.43,644.04 166.59,637.95 156.04,628.42 C152.59,625.30 151.93,623.91 150.08,615.88 C147.43,604.38 147.43,604.46 151.04,597.23 C154.94,589.43 167.90,576.98 181.64,567.82 C191.32,561.37 215.03,547.64 215.50,548.22 C215.62,548.37 217.47,553.86 219.61,560.42 C222.48,569.20 223.17,572.44 222.23,572.76 C221.54,572.99 215.21,576.64 208.17,580.86 C193.90,589.43 179.26,600.42 175.97,605.04 C172.73,609.60 174.81,612.07 184.16,614.79 C200.30,619.47 218.09,621.10 253.00,621.11 C299.53,621.12 351.01,616.20 417.00,605.43 C468.78,596.97 570.96,573.83 624.00,558.54 C660.72,547.95 710.15,531.48 736.52,521.03 C743.50,518.26 749.74,516.00 750.38,516.00 C751.01,516.00 752.35,518.36 753.35,521.25 C754.35,524.14 756.74,528.91 758.67,531.86 C760.60,534.81 761.80,537.58 761.34,538.00 C759.52,539.68 711.45,557.34 686.00,565.68 C633.25,582.96 607.58,589.91 533.60,606.96 C478.92,619.56 454.64,624.62 425.50,629.46 C342.09,643.30 273.71,648.79 221.39,645.84 ZM 786.22 542.08 C775.76,538.21 768.29,531.12 763.19,520.24 C760.83,515.21 760.50,513.26 760.50,504.50 C760.50,495.73 760.83,493.79 763.20,488.75 C766.97,480.69 774.90,472.64 782.93,468.73 C788.98,465.78 790.29,465.52 799.52,465.51 C808.84,465.50 810.01,465.73 816.22,468.79 C825.01,473.12 831.36,479.43 835.31,487.78 C838.27,494.01 838.50,495.26 838.49,505.00 C838.49,514.57 838.23,516.03 835.56,521.50 C831.82,529.14 824.16,536.80 816.53,540.53 C808.58,544.42 794.47,545.14 786.22,542.08 ZM 846.42 489.38 C845.45,486.30 842.97,481.18 840.92,477.99 L 837.18 472.21 L 842.39 468.62 C845.26,466.64 850.21,462.61 853.39,459.65 C860.09,453.41 860.50,450.77 855.25,447.71 C850.54,444.97 831.56,441.38 814.38,439.99 C805.58,439.28 799.20,438.32 798.77,437.64 C798.36,437.01 798.00,435.15 797.96,433.50 C797.92,431.85 797.33,426.79 796.65,422.25 L 795.41 414.00 L 800.95 414.01 C818.31,414.04 847.43,418.18 859.83,422.38 C875.63,427.72 880.76,432.66 883.86,445.50 C886.17,455.03 886.00,457.22 882.47,464.06 C879.88,469.08 868.68,480.41 859.61,487.19 C847.78,496.02 848.47,495.91 846.42,489.38 Z";
const SATELLITE_ICON = (typeof Path2D !== 'undefined') ? new Path2D(SATELLITE_ICON_PATH) : null;
// 아이콘 바운딩박스 중심·크기 (viewBox 1024) — 위치 보정용
const SAT_BBOX = { cx: 516.7, cy: 531.4, w: 739, h: 235 };
...
function draw() {
  ...
  nodes.forEach(n => {
    ...
    if(n._satelliteRoot && SATELLITE_ICON) {
      ...
      ctx.fillStyle = isDim ? 'rgba(255,122,1,0.18)' : 'rgba(255,122,1,0.95)';
