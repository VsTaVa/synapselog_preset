...
const LANG = {
  ko: {
    ...
    's-export':'이미지 내보내기','s-export-label':'그래프 이미지 저장','s-export-sub':'크기를 고르면 PNG로 저장',
  ...
  en: {
    ...
    's-export':'Export Image','s-export-label':'Save graph image','s-export-sub':'Pick a size to save as PNG',
