...
// 1을 기준으로 줄이기만 하면 전체가 얇아져 잘 안 보인다 → 얕은 쪽을 키우는 방향으로 잡는다
// (가장 깊은 단계도 예전 두께 아래로 내려가지 않게).
function edgeDepthScale(level) { return [1.3, 1.3, 1.15, 1.0, 0.9, 0.82][Math.min(level, 5)]; }
...
function _markHtml(mark) {
  if (mark === '💡') return `<svg class="body-edit-mark-ic" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5A4.61 4.61 0 0 1 8.91 14"/></svg>`;
